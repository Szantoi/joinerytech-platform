...
const LEADS_SEED = [
  ...
  { id: "LEAD-2426-001", status: "uj", source: "webshop", owner: "Szabó A.",
    company: "", contact: "Fiktiv Ferenc · kapcsolat@pelda.hu", email: "kapcsolat@pelda.hu", phone: "+36 30 244 5512", city: "Budapest",
  ...
  { id: "LEAD-2426-002", status: "kapcsolat", source: "kiallitas", owner: "Kovács P.",
    company: "Novitech Mérnökiroda Kft.", contact: "Kitalált Katalin · kapcsolat@pelda.hu", email: "kapcsolat@pelda.hu", phone: "+36 1 388 2210", city: "Budapest",
  ...
  { id: "LEAD-2426-003", status: "minosites", source: "ajanlas", owner: "Szabó A.",
    company: "Bistro Central", contact: "Adat András · kapcsolat@pelda.hu", email: "kapcsolat@pelda.hu", phone: "+36 70 119 4420", city: "Budapest",
  ...
  { id: "LEAD-2426-004", status: "nurturing", source: "telefon", owner: "Szabó A.",
    company: "", contact: "Sablon Sára · kapcsolat@pelda.hu", email: "kapcsolat@pelda.hu", phone: "+36 20 556 7781", city: "Balatonfüred",
  ...
  { id: "LEAD-2426-005", status: "elvetve", source: "email", owner: "Kovács P.",
    company: "", contact: "Vazlat Viktor · kapcsolat@pelda.hu", email: "kapcsolat@pelda.hu", phone: "+36 30 901 2244", city: "Szeged",
  ...
  { id: "LEAD-2426-006", status: "konvertalva", source: "belsoepitesz", owner: "Kovács P.",
    company: "Vella Interior Design", contact: "Proba Petra · kapcsolat@pelda.hu", email: "kapcsolat@pelda.hu", phone: "+36 1 567 890", city: "Budapest",
...
const OPPS_SEED = [
  ...
  { id: "OPP-2426-001", status: "nyitott", owner: "Kovács P.",
    customer: "Vella Interior Design", contact: "Modell Mónika · kapcsolat@pelda.hu", phone: "+36 1 567 890", city: "Budapest",
  ...
  { id: "OPP-2426-002", status: "igenyfelmeres", owner: "Kovács P.",
    customer: "Doorstar Hungary Zrt.", contact: "Jelolt Júlia · kapcsolat@pelda.hu", phone: "+36 27 123 456", city: "Vác",
  ...
  { id: "OPP-2426-003", status: "ajanlat", owner: "Szabó A.",
    customer: "Várdai Konyhastúdió", contact: "Kepzelt Krisztián · kapcsolat@pelda.hu", phone: "+36 52 234 124", city: "Debrecen",
  ...
  { id: "OPP-2426-004", status: "targyalas", owner: "Kovács P.",
    customer: "Hegyi Lakberendezés", contact: "Illusztr Ilona · kapcsolat@pelda.hu", phone: "+36 99 312 444", city: "Sopron",
  ...
  { id: "OPP-2426-005", status: "megnyert", owner: "Szabó A.",
    customer: "Bognár Bútor Kft.", contact: "Mockup Máté · kapcsolat@pelda.hu", phone: "+36 72 412 333", city: "Pécs",
  ...
  { id: "OPP-2426-006", status: "elveszett", owner: "Szabó A.",
    customer: "Pesti Ablakműhely", contact: "Stub Szilvia · kapcsolat@pelda.hu", phone: "+36 1 422 100", city: "Budapest",
