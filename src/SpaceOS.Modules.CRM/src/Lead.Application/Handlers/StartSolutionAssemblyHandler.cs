...
/// <summary>
/// Handler for StartSolutionAssemblyCommand.
/// Transitions opportunity from NeedsAssessment → SolutionAssembly, sets probability to 50%.
/// </summary>
public sealed class StartSolutionAssemblyHandler : IRequestHandler<StartSolutionAssemblyCommand, Result<OpportunityDto>>
{
    private readonly IOpportunityRepository _opportunityRepository;
    private readonly IPublisher _publisher;

    public StartSolutionAssemblyHandler(IOpportunityRepository opportunityRepository, IPublisher publisher)
    {
        _opportunityRepository = opportunityRepository;
        _publisher = publisher;
    }

    public async Task<Result<OpportunityDto>> Handle(StartSolutionAssemblyCommand request, CancellationToken cancellationToken)
    {
        ...
        var transitionResult = opportunity.StartSolutionAssembly(request.ActedBy);
