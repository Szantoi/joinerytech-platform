    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                operating_hours = table.Column<decimal>(type: "decimal(15,2)", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                estimated_hours = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                actual_hours = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
        ...
        // Asset maintenance plans table (owned collection)
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                interval_hours = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                estimated_hours = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                last_done = table.Column<DateOnly>(type: "date", nullable: true),
                last_done_hours = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                assignee_type = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                assignee_employee_id = table.Column<Guid>(type: "uuid", nullable: true)
            },
            constraints: table =>
            {
                table.PrimaryKey("pk_asset_maintenance_plans", x => x.id);
                table.ForeignKey(
        ...
        // Work order parts table (owned collection)
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                unit_price_amount = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
