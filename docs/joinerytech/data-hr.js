...
const EMPLOYEES_SEED = [
  { id: "emp-nagyj", name: "Dummy Dániel", initials: "NJ", role: "Beépítő vezető / sofőr", dept: "szereles", facilityId: "fac-vac",
  ...
  { id: "emp-kissa", name: "Sample Sándor", initials: "KA", role: "Élzáró / CNC operátor", dept: "gyartas", facilityId: "fac-vac",
  ...
  { id: "emp-tothk", name: "Fixture Fanni", initials: "TK", role: "Szabász operátor", dept: "gyartas", facilityId: "fac-vac",
  ...
  { id: "emp-horvg", name: "Seed Sebestyén", initials: "HG", role: "Beépítő szerelő", dept: "szereles", facilityId: "fac-vac",
  ...
  { id: "emp-feketep", name: "Minta Márton", initials: "FP", role: "Felmérő / sofőr", dept: "logisztika", facilityId: "fac-bp",
  ...
  { id: "emp-horve", name: "Példa Piroska", initials: "HE", role: "CNC operátor", dept: "gyartas", facilityId: "fac-szek",
  ...
  { id: "emp-szaboa", name: "Teszt Tamás", initials: "SA", role: "Értékesítő", dept: "ertekesites", facilityId: "fac-vac",
  ...
  { id: "emp-kovacsp", name: "Demo Dóra", initials: "KP", role: "Tervező / ügyvezető", dept: "tervezes", facilityId: "fac-vac",
  ...
  { id: "emp-vargal", name: "Fiktiv Ferenc", initials: "VL", role: "Felületkezelő / lakkozó", dept: "gyartas", facilityId: "fac-vac",
  ...
  { id: "emp-balogm", name: "Kitalált Katalin", initials: "BM", role: "Betanított segéd", dept: "gyartas", facilityId: "fac-vac",
  ...
  { id: "emp-nemethz", name: "Adat András", initials: "NZ", role: "Tervező (CAD)", dept: "tervezes", facilityId: "fac-bp",
