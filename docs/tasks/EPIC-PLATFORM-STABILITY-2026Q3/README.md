...
|---|---|---:|---|---|
| [`STAB-CUTTING-EDGE-PROXY-INCIDENT`](archive/STAB-CUTTING-EDGE-PROXY-INCIDENT.md) | infra + backend/security | **P0 incident** | nincs | ✅ done — elsőként; éles edge emberi kapuval |
...
| [`STAB-RLS-PROOF`](archive/STAB-RLS-PROOF.md) | backend/security | P0 | ADR-IMPL-HOSTING done | ✅ done — csak modul-lockkal |
| [`STAB-CUTTING-TENANT-RESOLVER`](archive/STAB-CUTTING-TENANT-RESOLVER.md) | backend/security | P0 | nincs | ✅ done — Cutting modul-lock alatt, EHS/portal sávoktól külön |
...
| [`STAB-CUTTING-CULTURE-INVARIANCE`](archive/STAB-CUTTING-CULTURE-INVARIANCE.md) | backend/integration | P0 | nincs | ✅ done — Cutting modul-lock alatt, külön Pricing/OptiCut fájlok |
| [`STAB-CUTTING-SUBPROCESS-PORTABILITY`](archive/STAB-CUTTING-SUBPROCESS-PORTABILITY.md) | backend/integration | P0 | nincs | ✅ done — Cutting tesztfájl, production sávtól külön |
...
| [`STAB-CUTTING-EMAIL-BOUNDARY`](archive/STAB-CUTTING-EMAIL-BOUNDARY.md) | backend/integration | P0 | nincs | ✅ done — Cutting EmailService fájlok, más sávoktól külön |
| [`STAB-CUTTING-QUOTE-HARNESS`](archive/STAB-CUTTING-QUOTE-HARNESS.md) | backend/security + integration | P0 | email boundary lokális | ✅ done — Quote API/command/repository + tesztfixture lock |
...
| [`STAB-EHS-INTEGRATION`](archive/STAB-EHS-INTEGRATION.md) | backend | P0 | hosting merge | ✅ done — RLS-től külön, ha EHS persistence lock szabad |
...
| [`STAB-TESTCONTAINERS-HYGIENE`](archive/STAB-TESTCONTAINERS-HYGIENE.md) | infra/backend | P0 | EHS fixture-döntés | ✅ done — FE-vel párhuzamos |
| [`STAB-FE-TEST-GATE`](archive/STAB-FE-TEST-GATE.md) | frontend | P1 | portal lock | ✅ done — backend taskokkal párhuzamos |
| [`STAB-RELEASE-REPRO`](archive/STAB-RELEASE-REPRO.md) | infra/monitor | P1 | előző négy | ✅ done — utolsó kapu |
